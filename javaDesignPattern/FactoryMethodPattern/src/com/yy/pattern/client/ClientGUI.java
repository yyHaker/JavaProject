...
import com.yy.pattern.creator.BodyPolicy;
import com.yy.pattern.creator.CollPolicy;
import com.yy.pattern.creator.ComPolicy;
import com.yy.pattern.creator.LuxeryCarPolicyProducer;
import com.yy.pattern.creator.PersonPolicy;
import com.yy.pattern.creator.PolicyProducer;
import com.yy.pattern.creator.PropPolicy;
...
public class ClientGUI extends JFrame {
  ...
  //添加一个静态常量
  public static final String LUXERYCARINSURANCE="LuxeryCar Insuarance";
      ...
      public void actionPerformed(ActionEvent ae) {
		...
		if (ae.getActionCommand().equals(SHOW)) {
		    ...
		    if (type.equals(BODYINJURE)) {
		    	...
		    	pp=new LuxeryCarPolicyProducer();
		    }
		    //增加一个判断
