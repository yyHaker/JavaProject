...
import com.yy.pattern.Adapter.InformationAdapter;
import com.yy.pattern.face.CusInfoValidator;
...
public class AdapterTestGUI extends JPanel{
   ...
   private JLabel lblCustomerName, lblAddress,
           lblZip, lblCellphone, lblSSN,lbEmail;
   ...
   private void setUpButtonPanel(){
	  ...
	  //添加一个email的标签
	  lbEmail=new JLabel("emai address:");
	  ...
	  //添加txtEmail和lableEmail
	  gbc.gridx = 0;
	  gbc.gridy = 5;
	  gridbag.setConstraints(lbEmail, gbc);
	  gbc.gridx = 1;
	  gbc.gridy = 5;
