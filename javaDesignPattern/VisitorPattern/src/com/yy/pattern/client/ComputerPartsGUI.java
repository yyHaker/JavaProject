...
import com.yy.pattern.parts.*;
import com.yy.pattern.visitor.PartsInfoVisitor;
import com.yy.pattern.visitor.PriceVisitor;
import com.yy.pattern.visitor.SalesStatusVisitor;
...
public class ComputerPartsGUI extends JFrame implements ItemListener{
  ...
  private void createPartObjAndVisitParts(ActionEvent e){
	 ...
	 // PartsInfoVisitor iv = new PartsInfoVisitor();
	  //此处更换为SalesStatusVisitor类的对象
	  SalesStatusVisitor sv=new SalesStatusVisitor();
	  ...
	  if (e.getActionCommand().equals("Submit")) {
        ...
        // txtAreaData.append("\n Parts descriptions: " + iv.printAllOrderInfo()+"\n");
          txtAreaData.append("\n =========== sale status statics===========");
          txtAreaData.append("\n All sale information: "+sv.printAllSaleInfor()+"\n");
	  }
