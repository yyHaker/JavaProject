...
import com.yy.pattern.info.AgentInfo;
import com.yy.pattern.info.EncryptedInfo1;
import com.yy.pattern.info.EncryptedInfo2;
import com.yy.pattern.info.EncryptedInfo3;
import com.yy.pattern.writer.DBWriter;
import com.yy.pattern.writer.MessageWriter;
import com.yy.pattern.writer.FileWriter;
...
public class AgentGUI extends JFrame
{
  ...
  //添加一个encryption3
  public static final String 	ROTATEENCRYPTION="rotateencryption";
  ...
  public AgentGUI() {
    ...
    //添加一个rotateencryption
    cmbEncryptMethod.addItem(ROTATEENCRYPTION);
    ...
    if (e.getActionCommand().equals(AgentGUI.ADDINFO)) {
      ...
      //Create a customer object
       ...
       if(encryptWay.compareTo(AgentGUI.BIDIRSHIFTENCRYPTION)==0)
        ...
        if(encryptWay.compareTo(AgentGUI.ROTATEENCRYPTION)==0){
