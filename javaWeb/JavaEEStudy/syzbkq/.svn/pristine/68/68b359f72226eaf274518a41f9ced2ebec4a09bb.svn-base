...
(function ($) {
    ...
    function MultipleSelect($el, options) {
        ...
        if(typeof($el.attr("selectValue"))!="undefined"){
        	$("option").each(function(){
        		if($(this).val() == $el.attr("selectValue")){
    ...
    MultipleSelect.prototype = {
        ...
        append: function (values) {
        	...
        	$.each(values,function(n,item){
        		$el.append("<option value='"+item['code']+"'>"+item['value']+"</option>");
        	});
        ...
        filter: function () {
            ...
            if (text.length === 0) {
                ...
                /**
                 * 修改 当查询无结果，再次查询有结果时提示消息仍然存在的BUG
                 * @author liu.jia_neu
                 */
